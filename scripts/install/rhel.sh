...
if [ "$VERSION_ID" -ge "8" ];then
    ...
    for rpms in gcc gcc-c++ lsof autoconf bzip2 bzip2-devel c-ares-devel \
        ...
        oniguruma oniguruma-devel patch pcre pcre-devel perl perl-Data-Dumper perl-devel perl-IPC-Cmd perl-Time-Piece perl-Test-Simple procps psmisc python3-devel \
    ...
    for rpms in gcc gcc-c++ lsof autoconf bison bzip2 bzip2-devel c-ares-devel ca-certificates cairo-devel \
        ...
        openssl openssl-devel patch pcre pcre-devel perl perl-Data-Dumper perl-devel perl-IPC-Cmd perl-Time-Piece perl-Test-Simple psmisc python-devel \
        pv bc bind-utils \
        ncurses-compat-libs numactl \
