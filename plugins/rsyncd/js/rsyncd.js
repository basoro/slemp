            ...
            success: function () {
                ...
                $("select[name='delete']").change(function () {
                    if ($(this).val() == 'true') {
                        ...
                        layer.confirm(msg, {
                            title: 'Data Security Risk Warning', icon: 2, closeBtn: 1, shift: 5,
                            btn2: function () {
        ...
        content: '<div class="lsyncd_exclude">\
                <div style="overflow:hidden;">\
                    <fieldset>\
                        ...
                        <input type="text" class="bt-input-text mr5" data-type="exclude" title="For example：/opt/slemp" placeholder="For example：*.log" style="width:305px;">\
