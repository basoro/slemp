...
function Terms_WebSocketIO_Create(ip, random){
    ...
    n.registerCloseCallBack(function(){
        ...
        layer.msg('['+ip+'] has been closed', { icon: 1, time: 3000 });
    });
...
function webShell_openTermView(info) {
    if (typeof info === "undefined") {
        info = { host: '127.0.0.1', ps: 'local server' }
    }
    ...
    appPost('get_server_list', {}, function(rdata){
        ...
        $('.tootls_host_list .host').on('click', function (e) {
            ...
            if ($('.item[data-host="' + host + '"]').length > 0) {
                layer.msg('Already opened!', { icon: 0, time: 3000 });
            } else {
    ...
    layer.open({
        ...
        content:'<div class="bt-form pd20 c6">\
                    <div class="line input_group">\
                        ...
                        <div class="info-r">\
                            <input type="text" name="host" class="bt-input-text mr5" style="width:240px" value="127.0.0.1" placeholder="Enter server IP" val="" autocomplete="off" />\
                    ...
                    <div class="line">\
                        ...
                        <div class="info-r">\
                            <input type="text" name="username" class="bt-input-text mr5" style="width:305px" placeholder="Enter the SSH account" value="root" autocomplete="off"/>\
                        </div>\
                    </div>\
                    <div class="line">\
                        <span class="tname">Ways of identifying</span>\
                        <div class="info-r">\
                            <div class="btn-group">\
                                <button type="button" tabindex="-1" class="btn btn-sm auth_type_checkbox btn-default btn-success" data-ctype="0">Password validation</button>\
                                <button type="button" tabindex="-1" class="btn btn-sm auth_type_checkbox btn-default" data-ctype="1">Private key verification\
                                </button>\
                            </div>\
                        </div>\
                    </div>\
                    <div class="line c_password_view show">\
                        ...
                        <div class="info-r">\
                            <input type="text" name="password" class="bt-input-text mr5" placeholder="Please enter the SSH password" style="width:305px;" value="" autocomplete="off"/>\
                        </div>\
                    </div>\
                    <div class="line c_pkey_view hide">\
                        <span class="tname">Private key</span>\
                        <div class="info-r">\
                            <textarea rows="4" name="pkey" class="bt-input-text mr5" placeholder="Please enter the SSH private key" style="width:305px;height: 80px;line-height: 18px;padding-top:10px;"></textarea>\
                        </div>\
                    </div>\
                    <div class="line key_pwd_line hide" style="display:none;">\
                        <span class="tname">Private password</span>\
                        <div class="info-r">\
                            <input type="text" name="pkey_passwd" class="bt-input-text mr5" placeholder="Please enter the private key password" style="width:305px;" value="" autocomplete="off"/>\
                        </div>\
                    </div>\
                    <div class="line ssh_ps_tips">\
                        <span class="tname">Description</span>\
                        <div class="info-r">\
                            <input type="text" name="ps" class="bt-input-text mr5" placeholder="Please enter remarks, can be empty" style="width:305px;" value="" autocomplete="off"/>\
                        </div>\
                    </div>\
                </div>',
        success:function(){
...
function webShell_cmd(title='', cmd=''){
    layer.open({
        type: 1,
        title: 'Add common command information',
        area: '500px',
        btn:["Submit","Cancel"],
        content:'<div class="bt-form pd20 c6">\
                    <div class="line">\
                        <span class="tname">Command name</span>\
                        <div class="info-r">\
                            <input type="text" name="title" class="bt-input-text mr5" style="width:305px" placeholder="Please enter a common command description, required" value="'+title+'" autocomplete="off"/>\
                        </div>\
                    </div>\
                    <div class="line">\
                        <span class="tname">Command content</span>\
                        <div class="info-r">\
                            <textarea rows="4" name="cmd" class="bt-input-text mr5" placeholder="Please enter common command information, required" style="width:305px;height: 150px;line-height: 18px;padding-top:10px;">'+cmd+'</textarea>\
                        </div>\
                    </div>\
                </div>',
        success:function(){
