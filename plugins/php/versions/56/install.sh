...
# cd ${rootPath}/plugins/php && /bin/bash install.sh install 56
...
if [ "${SYS_ARCH}" == "aarch64" ];then
	# 修复aarch64架构下安装
	# ${rootPath}/plugins/php/versions/56/src/zend_multiply.h > ${serverPath}/source/php/php56/Zend/zend_multiply.h
