...
def httpUpload(url, timeout=10):
    try:
        ...
        files = {
            'file': open('/Users/midoks/Desktop/slemp/server/op_waf/version.pl', 'rb')
        }
...
if __name__ == "__main__":
    os.system('cd /Users/midoks/Desktop/slemp/server/panel/ && python3 /Users/midoks/Desktop/slemp/server/panel/plugins/op_waf/index.py reload')
    test_start()
